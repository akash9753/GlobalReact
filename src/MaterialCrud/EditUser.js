                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='form-group' style={{ marginTop: 20 }}>
                            ...
                            <input className={classNames("form-control", { "is-invalid": errors.fname })}
                                type="text" id='fname' name="fname" value={user.fname} 
                        ...
                        <div className='form-group'>
                            ...
                            <input className={classNames("form-control", { "is-invalid": errors.lname })}
                                type="text" id='lname' name="lname" value={user.lname} 
                        ...
                        <div className='form-group'>
                            ...
                            <input value={user.mobile} className={classNames("form-control", { "is-invalid": errors.mobile })}
                                {...register("mobile", { required: true, pattern: /^([0-9]{10,12})$/ })} onChange={(e) => onValueChange(e)} />
                        ...
                        <div className='form-group'>
                            ...
                            <select value={user.state} className={classNames("form-control", { "is-invalid": errors.state })}
                                {...register("state", { required: true })} onChange={(e) => onValueChange(e)}>
                            ...
                            <button type='submit' className='btn btn-primary' style={{ marginTop: 4 }}>Edit</button>
                    </form>
